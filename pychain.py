...
# Note: The starter code provided a st.cache function which is now deprecated. I have replaced this function with st.cache_resource, which does not have the 'allow_output_mutation' parameter.
@st.cache_resource()
def setup():
